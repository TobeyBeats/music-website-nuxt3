			...
			<div>
				...
				">
					<div v-for="participant in release.participants" :key="participant.displayName">
						...
						<p>
							<span v-if="participant.contributor.links.instagram"><a class="link" target="_blank" :href="participant.contributor.links.instagram">Instagram&nbsp;↗&#xFE0E;</a> </span>&ZeroWidthSpace;
							<span v-if="participant.contributor.links.youtube"><a class="link" target="_blank" :href="participant.contributor.links.youtube">Youtube&nbsp;↗&#xFE0E;</a> </span>&ZeroWidthSpace;
							<span v-if="participant.contributor.links.spotify"><a class="link" target="_blank" :href="participant.contributor.links.spotify">Spotify&nbsp;↗&#xFE0E;</a> </span>&ZeroWidthSpace;
							<span v-if="participant.contributor.links.website"><a class="link" target="_blank" :href="participant.contributor.links.website">Website&nbsp;↗&#xFE0E;</a></span>
						</p>
					</div>
				</div>
			</div>
