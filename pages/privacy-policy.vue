<template>
	<div>
		...
		<ul>
			...
			<li>
				<p><strong>Country</strong> refers to: Saarland, Germany</p>
			</li>
			<li>
		...
		<h3>Usage Data</h3>
		<p>Usage Data is collected automatically by our website host Netlify when using the Service.</p>
		...
		<p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain
			...
			deleted as soon as You close Your web browser. Learn more about cookies: <a
				href="https://www.privacypolicies.com/blog/cookies/" target="_blank">What Are Cookies?</a>.
		</p>
		...
		<p>You can object to the use of cookies for online marketing purposes using a variety of services,
			especially in the case of tracking, via the websites http://optout.aboutads.info and
